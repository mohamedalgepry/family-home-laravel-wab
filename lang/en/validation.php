...
return [
    ...
    */
    ...
    'custom' => [
        'coordinates' => [
            'not_zero' => 'Coordinates cannot be (0, 0). Please select a valid location on the map.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'images.*' => 'Image file',
        'video_url' => 'Video URL',
        'map_embed_url' => 'Google Maps URL',
        'latitude' => 'Latitude',
        'longitude' => 'Longitude',
        'location_address_ar' => 'Arabic Address',
        'location_address_en' => 'English Address',
        'email' => 'Email',
        'password' => 'Password',
