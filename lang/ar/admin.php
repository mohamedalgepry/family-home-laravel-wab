...
return [
    ...
    'knowledge_saved' => 'تم حفظ الرد الجاهز في بنك المعرفة بنجاح',
    'knowledge_updated' => 'تم تحديث الرد في بنك المعرفة بنجاح',
    'knowledge_deleted' => 'تم حذف الرد من بنك المعرفة بنجاح',
    'knowledge_enabled' => 'تم تفعيل الرد بنجاح',
    'knowledge_disabled' => 'تم تعطيل الرد',
    'knowledge_cache_cleared' => 'تم تحديث كاش المعرفة فوراً',
    'export_csv' => 'تصدير CSV',
    'confirm_delete_title' => 'تأكيد عملية الحذف',
    'confirm_delete_desc' => 'هل أنت متأكد من رغبتك في حذف هذا العنصر نهائياً؟ لا يمكن التراجع عن هذا الإجراء.',
    'cancel' => 'إلغاء',
    'delete' => 'حذف',
    'clear_all_notifications_title' => 'مسح جميع الإشعارات',
    'clear_all_notifications_desc' => 'هل أنت متأكد من رغبتك في حذف جميع الإشعارات؟ لا يمكن التراجع عن هذا الإجراء.',
    'csv_id' => 'المعرف',
    'csv_name' => 'الاسم',
    'csv_phone' => 'الهاتف',
    ...
    'csv_agent' => 'الوسيط',
    'csv_status' => 'الحالة',
    'csv_content' => 'نص الرسالة',
    'csv_created_at' => 'تاريخ الإرسال',
    'csv_replied_at' => 'تاريخ الرد',
    'csv_lead_score' => 'درجة الاهتمام',
    'csv_lead_type' => 'تصنيف العميل',
    'csv_context' => 'السياق والطلب',
    'csv_registered_at' => 'تاريخ التسجيل',
    'csv_general' => 'عام',
    'csv_unspecified' => 'غير محدد',
    'csv_status_pending' => 'جديد',
    'csv_status_replied' => 'تم الرد',
    'csv_status_contacted' => 'تم التواصل',
    'csv_status_new' => 'جديد',
];
