...
Route::prefix('admin')->middleware(['auth', 'role:admin,manager,agent'])->group(function () {
    ...
    Route::post('/units/{unit}/approve', [NotificationController::class, 'approveUnit'])->middleware('role:admin,manager')->name('admin.units.approve');
    ...
    Route::post('/units/{unit}/extend-expiry', [NotificationController::class, 'extendUnit'])->middleware('role:admin,manager')->name('admin.units.extend-expiry');
