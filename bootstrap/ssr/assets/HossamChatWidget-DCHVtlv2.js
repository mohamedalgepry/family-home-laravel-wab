...
function InstallmentCalculatorCard({ isRtl, trans, onApplyBudget, onClose }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		className: "bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-2xl p-4 my-2.5 shadow-lg border border-slate-700/60 w-full max-w-[96%]",
		children: [
			/* @__PURE__ */ jsxs("div", {
				className: "flex items-center justify-between pb-2 border-b border-slate-700/50 mb-3",
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("span", {
							...
							className: "font-bold text-amber-400 font-mono text-xs",
							children: [Number(price).toLocaleString(), " ج.م"]
						})]
					}),
					/* @__PURE__ */ jsx("input", {
						type: "range",
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: [
							...
							1e7,
							15e6
						].map((qp) => /* @__PURE__ */ jsxs("button", {
							type: "button",
							onClick: () => setPrice(qp),
							className: `text-[9.5px] px-1.5 py-0.5 rounded border transition-colors ${price === qp ? "bg-amber-400/20 border-amber-400 text-amber-300 font-bold" : "bg-slate-800 border-slate-700 text-slate-400 hover:text-white"}`,
							children: [qp / 1e6, "M"]
						}, qp))
					})
				]
			...
			/* @__PURE__ */ jsxs("div", {
				className: "grid grid-cols-2 gap-3 mb-3 pt-2 border-t border-slate-700/40",
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						className: `flex-1 text-[10px] py-1 rounded border transition-colors ${downPercent === pct ? "bg-emerald-500/20 border-emerald-500 text-emerald-300 font-bold" : "bg-slate-800 border-slate-700 text-slate-400 hover:text-white"}`,
						children: [pct, "%"]
					}, pct))
					...
					children: [/* @__PURE__ */ jsx("span", {
						...
						className: "font-bold text-sky-400 font-mono text-xs",
						children: [
							years,
							" ",
							trans("years")
					...
					children: [
						...
						type: "button",
						onClick: () => setYears(yr),
						className: `flex-1 text-[10px] py-1 rounded border transition-colors ${years === yr ? "bg-sky-500/20 border-sky-500 text-sky-300 font-bold" : "bg-slate-800 border-slate-700 text-slate-400 hover:text-white"}`,
						children: yr
					}, yr))
				})] })]
			}),
			/* @__PURE__ */ jsxs("div", {
				className: "grid grid-cols-3 gap-1.5 p-2 bg-slate-950/60 rounded-xl mb-3 text-center border border-slate-800",
				children: [
					/* @__PURE__ */ jsxs("div", {
						className: "p-1",
						children: [/* @__PURE__ */ jsx("p", {
							...
							className: "text-[11px] font-bold text-emerald-400 font-mono truncate",
							children: Math.round(downPayment).toLocaleString()
						})]
					}),
					/* @__PURE__ */ jsxs("div", {
						className: "p-1 border-x border-slate-800",
						children: [/* @__PURE__ */ jsx("p", {
							className: "text-[9px] text-slate-400",
							children: trans("assistant_monthly_installment")
						}), /* @__PURE__ */ jsx("p", {
							className: "text-[11px] font-bold text-amber-400 font-mono truncate",
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("p", {
							...
							className: "text-[11px] font-bold text-sky-400 font-mono truncate",
			...
			/* @__PURE__ */ jsxs("button", {
				...
				children: [/* @__PURE__ */ jsx("span", { children: "🔍" }), /* @__PURE__ */ jsx("span", { children: trans("assistant_search_matching_units") })]
			})
		]
	});
}
		...
		children: [!isOpen && /* @__PURE__ */ jsxs("div", {
			...
			children: [
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("button", {
									...
									className: `w-8 h-8 rounded-lg flex items-center justify-center transition-colors ${showCalculator ? "bg-amber-100 text-amber-800" : "text-slate-500 hover:bg-slate-100 hover:text-slate-900"}`,
				...
				showCalculator && /* @__PURE__ */ jsx("div", {
					className: "px-4 py-3 bg-slate-900 border-b border-slate-700",
				...
				showQuickQuestions && /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("p", {
							...
							children: [/* @__PURE__ */ jsx("span", { children: "🧮" }), /* @__PURE__ */ jsx("span", { children: trans("assistant_calculator") })]
						})]
					}), /* @__PURE__ */ jsx("div", {
