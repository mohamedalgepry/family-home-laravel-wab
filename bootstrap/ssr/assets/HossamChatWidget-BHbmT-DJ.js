...
function InstallmentCalculatorCard({ isRtl, trans, onApplyBudget, onClose }) {
	const [price, setPrice] = useState(4e6);
	...
	const trackGradient = isRtl ? `linear-gradient(to left, #CC0000 0%, #CC0000 ${sliderPercent}%, #E2E8F0 ${sliderPercent}%, #E2E8F0 100%)` : `linear-gradient(to right, #CC0000 0%, #CC0000 ${sliderPercent}%, #E2E8F0 ${sliderPercent}%, #E2E8F0 100%)`;
	return /* @__PURE__ */ jsxs("div", {
		className: "bg-white text-slate-900 rounded-2xl p-4 sm:p-4.5 shadow-[0_4px_24px_-4px_rgba(0,0,0,0.08)] border border-slate-200/90 w-full transition-all",
		children: [
			/* @__PURE__ */ jsxs("div", {
				className: "flex items-center justify-between pb-3 border-b border-slate-100 mb-3.5",
				children: [/* @__PURE__ */ jsxs("div", {
					className: "flex items-center gap-2.5 min-w-0",
					children: [/* @__PURE__ */ jsx("div", {
						className: "w-8 h-8 rounded-xl bg-[#FFF5F5] border border-[#FFE3E3] text-[#CC0000] flex items-center justify-center shrink-0 shadow-2xs",
						children: /* @__PURE__ */ jsx(CalculatorIcon, { className: "w-4 h-4" })
					}), /* @__PURE__ */ jsxs("div", {
						className: "min-w-0",
						children: [/* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-1.5 flex-wrap",
							children: [/* @__PURE__ */ jsx("h4", {
								className: "text-[13px] font-black text-slate-900 leading-tight tracking-tight",
								children: trans("assistant_calculator_title")
							}), /* @__PURE__ */ jsx("span", {
								className: "text-[9px] font-bold text-[#8B0000] bg-[#FFF5F5] border border-[#FFE3E3] px-1.5 py-0.5 rounded",
								children: isRtl ? "حساب فوري" : "Live Calc"
							})]
						}), /* @__PURE__ */ jsx("p", {
							className: "text-[10px] text-slate-400 font-medium truncate mt-0.5",
							children: isRtl ? "محاكاة خطط السداد ومطابقة الميزانية" : "Simulate plans & match your budget"
						})]
					})]
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("span", {
							...
							children: trans("assistant_property_price")
						}), /* @__PURE__ */ jsxs("div", {
							className: "flex items-baseline gap-1 font-mono",
							children: [/* @__PURE__ */ jsx("span", {
								className: "text-lg sm:text-xl font-black text-slate-950 tabular-nums tracking-tight",
								children: Number(price).toLocaleString()
							}), /* @__PURE__ */ jsx("span", {
								className: "text-[10.5px] font-bold text-[#CC0000] bg-[#FFF5F5] border border-[#FFE3E3] px-1.5 py-0.5 rounded",
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: quickPrices.map((qp) => {
							const isSelected = price === qp;
							const label = qp >= 1e6 ? `${qp / 1e6}M` : `${qp / 1e3}K`;
							return /* @__PURE__ */ jsx("button", {
								type: "button",
								onClick: () => setPrice(qp),
								className: `text-[10px] px-2 py-0.5 rounded-lg border transition-all font-mono ${isSelected ? "bg-[#1A1A1A] border-[#1A1A1A] text-white font-bold shadow-xs" : "bg-slate-50 border-slate-200/80 text-slate-600 hover:bg-slate-100 hover:text-slate-900 hover:border-slate-300"}`,
								children: label
							}, qp);
						})
					})
			...
			/* @__PURE__ */ jsxs("div", {
				className: "grid grid-cols-2 gap-2.5 mb-3 pt-3 border-t border-slate-100",
				children: [/* @__PURE__ */ jsxs("div", {
					className: "bg-slate-50/70 p-2 rounded-xl border border-slate-200/60",
					children: [/* @__PURE__ */ jsxs("div", {
						className: "flex items-center justify-between text-[11px] mb-1.5",
						children: [/* @__PURE__ */ jsx("span", {
							className: "text-slate-500 font-medium",
							children: trans("assistant_down_payment")
						}), /* @__PURE__ */ jsxs("span", {
							className: "font-black text-[#CC0000] font-mono text-xs tabular-nums",
							children: [downPercent, "%"]
						})]
					}), /* @__PURE__ */ jsx("div", {
						...
						children: [
							...
							20,
							25
						].map((pct) => /* @__PURE__ */ jsxs("button", {
							type: "button",
							onClick: () => setDownPercent(pct),
							className: `text-[10px] py-1 rounded-md border font-semibold transition-all ${downPercent === pct ? "bg-[#CC0000] border-[#CC0000] text-white font-bold shadow-xs" : "bg-white border-slate-200 text-slate-600 hover:bg-slate-100 hover:text-slate-900"}`,
							children: [pct, "%"]
						}, pct))
					})]
				}), /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("span", {
							className: "text-slate-500 font-medium",
							children: trans("assistant_installment_duration")
						}), /* @__PURE__ */ jsxs("span", {
							className: "font-black text-slate-900 font-mono text-xs tabular-nums",
							children: [
								years,
								" ",
								trans("years")
						...
						children: [
							...
							8,
							10
						].map((yr) => /* @__PURE__ */ jsx("button", {
							type: "button",
							onClick: () => setYears(yr),
							className: `text-[10px] py-1 rounded-md border font-semibold transition-all ${years === yr ? "bg-[#1A1A1A] border-[#1A1A1A] text-white font-bold shadow-xs" : "bg-white border-slate-200 text-slate-600 hover:bg-slate-100 hover:text-slate-900"}`,
							children: yr
						}, yr))
					})]
				})]
			...
			/* @__PURE__ */ jsxs("div", {
				className: "grid grid-cols-3 gap-1.5 mb-3.5",
				children: [
					/* @__PURE__ */ jsxs("div", {
						className: "p-2 rounded-xl bg-slate-50 border border-slate-200/70 text-center",
						children: [
							/* @__PURE__ */ jsx("p", {
								className: "text-[9.5px] font-medium text-slate-500 truncate",
								children: trans("assistant_down_payment")
							}),
							/* @__PURE__ */ jsx("p", {
								className: "text-xs sm:text-[13px] font-black text-slate-900 font-mono truncate mt-0.5 tabular-nums",
								children: Math.round(downPayment).toLocaleString()
							}),
							/* @__PURE__ */ jsxs("p", {
								className: "text-[8.5px] text-slate-400 mt-0.5",
								children: [
									downPercent,
									"% ",
									isRtl ? "مقدم" : "down"
					...
					/* @__PURE__ */ jsxs("div", {
						className: "p-2 rounded-xl bg-[#FFF5F5] border border-[#FFE3E3] text-center relative overflow-hidden shadow-2xs",
						children: [
							/* @__PURE__ */ jsx("div", { className: "absolute top-0 inset-x-0 h-0.5 bg-[#CC0000]" }),
							/* @__PURE__ */ jsx("p", {
								className: "text-[9.5px] font-bold text-[#8B0000] truncate",
								children: trans("assistant_monthly_installment")
							}),
							/* @__PURE__ */ jsx("p", {
								className: "text-xs sm:text-[14px] font-black text-[#CC0000] font-mono truncate mt-0.5 tabular-nums",
								children: Math.round(monthly).toLocaleString()
							}),
							/* @__PURE__ */ jsx("p", {
								className: "text-[8.5px] font-bold text-[#8B0000]/70 mt-0.5",
								children: isRtl ? "شهرياً" : "Monthly"
							})
						]
					}),
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsx("p", {
								className: "text-[9.5px] font-medium text-slate-500 truncate",
								children: trans("assistant_quarterly_installment")
							}),
							/* @__PURE__ */ jsx("p", {
								className: "text-xs sm:text-[13px] font-black text-slate-900 font-mono truncate mt-0.5 tabular-nums",
								children: Math.round(quarterly).toLocaleString()
							}),
							/* @__PURE__ */ jsx("p", {
								className: "text-[8.5px] text-slate-400 mt-0.5",
								children: isRtl ? "كل ٣ أشهر" : "Quarterly"
							})
						]
					})
				]
			...
			/* @__PURE__ */ jsxs("button", {
				type: "button",
				onClick: () => {
					onApplyBudget(isRtl ? `عايز شقق بمقدم حوالي ${Math.round(downPayment).toLocaleString()} وقسط شهري في حدود ${Math.round(monthly).toLocaleString()} على ${years} سنوات` : `Looking for units with down payment around ${Math.round(downPayment).toLocaleString()} and monthly installments of ${Math.round(monthly).toLocaleString()} over ${years} years`);
				},
				...
				}), /* @__PURE__ */ jsx("span", { children: trans("assistant_search_matching_units") })]
			})
		]
	});
}
function HossamChatWidget() {
	...
	useEffect(() => {
		...
		let inviteText = null;
		if (pageProps.project?.name) inviteText = isRtl ? `بتتصفح مشروع ${pageProps.project.name}؟ تحب تشوف أنظمة السداد والأسعار المتاحة؟` : `Exploring ${pageProps.project.name}? Want to see payment plans and prices?`;
		else if (pageProps.unit?.name) inviteText = isRtl ? `مهتم بالوحدة دي؟ ممكن أساعدك تحسب القسط الشهري أو أرتبلك معاينة.` : `Interested in this unit? I can calculate monthly installments or book a visit.`;
		else if (currentPath.includes("/units/deals")) inviteText = isRtl ? `بتدور على صفقات استثمارية ولقطات؟ عندنا خيارات حصرية بخصم كاش وتقسيط!` : `Looking for top investment deals? Check out our exclusive properties!`;
		if (inviteText) {
	...
	const handleSendMessage = async (textToSend = null, retryMessageId = null) => {
		...
		const typingTimer2 = setTimeout(() => setTypingStage(2), 5e3);
		...
		for (let attempt = 1; attempt <= maxAttempts; attempt++) try {
			...
			if (data && data.success) {
				...
				if (data.show_calculator) setShowCalculator(true);
				if (words.length <= 4) {
					...
					if (audioEnabled) speakMessage(fullReply);
				} else {
					...
					streamIntervalRef.current = setInterval(() => {
						...
						if (wordIdx >= words.length) {
							...
							setMessages((prev) => prev.map((m) => m.id === newBotId ? {
								...m,
								content: fullReply
							} : m));
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [!isOpen && /* @__PURE__ */ jsxs("div", {
			...
			children: [
				proactivePill && /* @__PURE__ */ jsxs("div", {
					className: `absolute bottom-full mb-3 ${isRtl ? "end-0" : "start-0"} w-72 sm:w-80 bg-white/95 backdrop-blur-md border border-slate-200/90 rounded-2xl p-3.5 shadow-2xl transition-all duration-300 z-50`,
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [
									/* @__PURE__ */ jsx("span", {
										className: "w-6 h-6 rounded-full bg-[#1A1A1A] text-white flex items-center justify-center font-bold text-xs shrink-0",
										children: "H"
									}),
									/* @__PURE__ */ jsx("span", {
						...
						/* @__PURE__ */ jsx("p", {
							className: "text-xs text-slate-700 mt-2 leading-relaxed font-medium",
							children: proactivePill
						}),
						/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsx("button", {
								...
								children: trans("assistant_proactive_cta")
							})
						})
					]
				}),
			...
			children: [
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("button", {
									...
									className: `w-8 h-8 rounded-lg flex items-center justify-center transition-all duration-200 ${showCalculator ? "bg-[#1A1A1A] text-white shadow-xs" : "text-slate-500 hover:bg-slate-100 hover:text-slate-900"}`,
				...
				showCalculator && /* @__PURE__ */ jsx("div", {
					className: "px-3.5 py-3 bg-slate-50/95 border-b border-slate-200/80 backdrop-blur-sm transition-all duration-200",
					children: /* @__PURE__ */ jsx(InstallmentCalculatorCard, {
						isRtl,
						trans,
							...
							messages.map((msg) => {
								...
								return /* @__PURE__ */ jsxs("div", {
									...
									children: [
										...
										msg.show_calculator && /* @__PURE__ */ jsx("div", {
											className: "w-full mt-3 max-w-[96%]",
											children: /* @__PURE__ */ jsx(InstallmentCalculatorCard, {
												isRtl,
												trans,
				...
				showQuickQuestions && /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("p", {
							...
							children: [/* @__PURE__ */ jsx(CalculatorIcon, { className: "w-3.5 h-3.5 text-[#CC0000]" }), /* @__PURE__ */ jsx("span", { children: trans("assistant_calculator") })]
						})]
					}), /* @__PURE__ */ jsx("div", {
