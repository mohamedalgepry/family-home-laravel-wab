<?php
$content = file_get_contents('database/seeders/FamilyHomeAreasSeeder.php');
$start = strpos($content, '$areas = [');
$end = strpos($content, '];', $start);
$areas_code = substr($content, $start + 9, $end - $start - 8);

file_put_contents('temp_areas.php', "<?php\nreturn " . $areas_code . ";\n");

$areas = require 'temp_areas.php';
if (!is_array($areas)) {
    echo "Failed to extract areas array.\n";
    exit(1);
}

$out = "<?php\n\nnamespace Database\Seeders;\n\nuse Illuminate\Database\Seeder;\nuse App\Domain\Listings\Models\Area;\nuse Illuminate\Support\Facades\DB;\n\nclass FamilyHomeAreasSeeder extends Seeder\n{\n    public function run(): void\n    {\n        // We don't truncate because of foreign keys, just updateOrCreate\n        \$areas = [\n";
...
echo "Successfully generated seeder\n";
