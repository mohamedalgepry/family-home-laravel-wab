    ...
    return (
        <AdminSidebar>
            ...
            <div dir={isRtl ? 'rtl' : 'ltr'} className="p-6 max-w-3xl mx-auto">
                ...
                {/* Step Indicator */}
                <div className="bg-white p-3 sm:p-4 rounded-2xl border border-secondary-200/80 shadow-card mb-8">
                    <div className="flex items-center gap-2 overflow-x-auto pb-1 sm:pb-0">
                        {STEPS.map((s, i) => (
                            <div key={s.key} className="flex items-center gap-2 flex-1 min-w-[120px] sm:min-w-0">
                                <button
                                    type="button"
                                    onClick={() => i <= step ? setStep(i) : null}
                                    className={`px-3 py-1.5 rounded-xl text-xs font-bold flex items-center gap-2 transition-all ${i === step ? 'bg-primary-900 text-white shadow-md' :
