    ...
    return (
        <AdminSidebar>
            ...
            <div dir={isRtl ? 'rtl' : 'ltr'} className="p-4 sm:p-6 lg:p-8 space-y-6 max-w-7xl mx-auto">
                ...
                {/* ── Header Title & Add Unit Action ──────────────────────── */}
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-2xl md:rounded-3xl border border-secondary-200/80 shadow-card">
                    <div>
                    ...
                    <Link
                        ...
                        className="px-5 py-3 bg-primary-900 hover:bg-primary-950 text-white rounded-xl text-xs sm:text-sm font-bold shadow-sm transition-all flex items-center justify-center gap-2 active:scale-97 shrink-0"
                    >
                ...
                {/* ── Search & Filter Bar ───────────────────────────────── */}
                <div className="bg-white rounded-2xl border border-secondary-200/80 shadow-card p-5">
                    <form onSubmit={(e) => { e.preventDefault(); applyFilters(); }} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    placeholder={isRtl ? 'ابحث باسم العقار...' : 'Search by title...'}
                ...
                <div className="bg-white rounded-2xl md:rounded-3xl border border-secondary-200/80 shadow-card overflow-hidden">
                                ...
                                {loading ? (
                                    ...
                                    return (
                                        <tr key={unit.id} className="hover:bg-surface/60 transition-colors">
                                            ...
                                            <td className="px-4 py-3.5 whitespace-nowrap min-w-[210px]">
                                                <div className="flex items-center justify-center gap-1.5">
                                                    {(role !== 'agent' || unit.user_id === auth?.user?.id) && (
                                                        <Link
                                                            href={`/admin/units/${unit.id}/edit`}
                                                            className="px-3 py-1.5 text-xs font-bold text-blue-700 bg-blue-50 hover:bg-blue-100 rounded-xl transition-all border border-blue-200/70 flex items-center gap-1 active:scale-95"
                                                            title={trans('edit')}
                                                        >
                                                    ...
                                                    {role !== 'agent' && (
                                                        <button
                                                            ...
                                                            className="px-3 py-1.5 text-xs font-bold text-amber-800 bg-amber-50 hover:bg-amber-100 rounded-xl transition-all border border-amber-200/70 flex items-center gap-1 active:scale-95"
                                                    ...
                                                    {role !== 'agent' && (
                                                        <button
                                                            ...
                                                            className="px-3 py-1.5 text-xs font-bold text-red-700 bg-red-50 hover:bg-red-100 rounded-xl transition-all border border-red-200/70 flex items-center gap-1 active:scale-95"
                                                            title={trans('delete')}
                                                        >
                                                            <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
