                                                ...
                                                <div className="flex items-center justify-center gap-2 opacity-100 lg:opacity-0 lg:group-hover:opacity-100 transition-opacity duration-200">
                                                    {(role !== 'agent' || unit.user_id === auth?.user?.id) && (
                                                        <Link
                                                            ...
                                                            className="p-2 text-primary-900 bg-primary-50 hover:bg-[#CC0000] hover:text-white rounded-xl transition-colors focus:outline-none focus:ring-2 focus:ring-primary-900"
                                                            title={trans('edit')}
                                                        >
                                                            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                                    ...
                                                    {role !== 'agent' && (
                                                        <button
                                                            ...
                                                            className="p-2 text-amber-700 bg-amber-50 hover:bg-amber-500 hover:text-white rounded-xl transition-colors focus:outline-none focus:ring-2 focus:ring-amber-500"
                                                    ...
                                                    {role !== 'agent' && (
                                                        <button
                                                            ...
                                                            className="p-2 text-red-600 bg-red-50 hover:bg-red-600 hover:text-white rounded-xl transition-colors focus:outline-none focus:ring-2 focus:ring-red-500"
                                                            title={trans('delete')}
                                                        >
                                                            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
