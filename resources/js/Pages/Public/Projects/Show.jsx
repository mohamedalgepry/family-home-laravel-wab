                            ...
                            <div className="flex items-center justify-between gap-3">
                                <div className="flex items-center gap-3">
                                    <div className="w-10 h-10 rounded-full bg-primary-100 border border-primary-200 flex items-center justify-center text-primary-900 font-bold text-xs shrink-0">
                                        {project.user?.name ? project.user.name.charAt(0) : (isRtl ? 'أ' : 'A')}
                                    </div>
                                    <div className="min-w-0">
                                        <h4 className="text-xs font-bold text-secondary-950 truncate">{project.user?.name || (isRtl ? 'أحمد محمود' : 'Ahmed Mahmoud')}</h4>
