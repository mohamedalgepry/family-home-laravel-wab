    ...
    return (
        <div dir={isRtl ? 'rtl' : 'ltr'} className="min-h-screen bg-white flex flex-col font-sans">
            ...
            <main className="flex-1 w-full py-8 sm:py-14">
                ...
                {/* ── Focused Single-Column Editorial Article Container ──── */}
                ...
                {relatedArticles?.length > 0 && (
                    <section className="max-w-[1280px] mx-auto px-4 sm:px-6 mt-16 pt-12 border-t border-secondary-200" aria-labelledby="related-heading">
