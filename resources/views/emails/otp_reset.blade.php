...
<head>
    ...
    <title>{{ $isEnglish ? 'Password Reset Code' : 'رمز إعادة ضبط كلمة السر' }}</title>
    <style>
        body {
    ...
    <div class="email-container">
        ...
        <div class="body-content">
            @if($isEnglish)
                ...
                <p class="text">We received a request to reset your password for your Family Home account.</p>
            ...
            @else
                ...
                <p class="text">إذا لم تقم بطلب إعادة ضبط كلمة السر بنفسك، فيمكنك تجاهل هذه الرسالة بأمان.</p>
            @endif
        </div>
